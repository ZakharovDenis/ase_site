...
class UserLoginForm(forms.Form):
    ...
    Password=forms.CharField(label='', widget=(forms.PasswordInput(attrs={'placeholder':'Password','class':'textbox'})))
...
class UserForm(forms.ModelForm):
    ...
    fathers_name = forms.CharField(required=False, label='', widget=forms.TextInput(attrs={'placeholder':'Отчество','class':'textbox'}))
    email = forms.EmailField(label='', widget=forms.TextInput(attrs={'placeholder':'E-mail','class':'textbox'}))
    password=forms.CharField(label='', widget=forms.PasswordInput(attrs={'placeholder':'Пароль','class':'textbox'}))
